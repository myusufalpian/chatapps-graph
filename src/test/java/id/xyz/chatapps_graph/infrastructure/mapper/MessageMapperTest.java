...
class MessageMapperTest {
  ...
  void toResponse_MapsAllFields() {
    ...
    MessageResponse result = MessageMapper.toResponse(message, "sender-uuid", "conv-uuid", null, null);
  ...
  void toResponse_DeletedMessage_ContentNull() {
    ...
    MessageResponse result = MessageMapper.toResponse(message, "sender", "conv", null, null);
  ...
  void toResponse_WithAttachment_MapsAttachment() {
    ...
    MessageResponse result = MessageMapper.toResponse(message, "sender", "conv", att, null);
  ...
  void toResponse_WithReply_MapsReplyPreview() {
    ...
    MessageResponse result = MessageMapper.toResponse(message, "sender", "conv", null, reply);

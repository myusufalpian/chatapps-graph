...
@Service
@Slf4j
public class WablasWhatsAppProvider implements WhatsAppProvider {

  private final RestClient restClient;

  @Autowired
  public WablasWhatsAppProvider(WablasProperties properties) {
  ...
  // Visible for testing
  WablasWhatsAppProvider(RestClient restClient) {
  ...
  public void sendMessage(String phone, String otp) {
    ...
    log.info("WhatsApp OTP sent via Wablas to [{}]", MaskingUtil.maskPhone(phone));
  }
